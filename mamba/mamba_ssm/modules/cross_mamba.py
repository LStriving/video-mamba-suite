...
class Mamba(nn.Module):
    def __init__(
        ...
        self.d_value = d_value # value dim
    ...
    def forward(self, query_states, value_states, inference_params=None):
        """
        query_states: (B, L, D)
        value_states: (B, L, D')
        Returns: same shape as query_states
        """
        batch, seqlen, dim = query_states.shape
