...
do
    ...
    --re-extract \
    --ckpt2 ckpts/link2/2tower-crossattn-detach/pre-norm \
    ...
    --heatmap_size 56 \
    --image_size 128 \
    --tower_nam CrossAttnEarlyFusion-PreNorm > outputs/2tower_heatmape2e_crossattn_detach_prenorm/eval_${vw}.log
done