#!/bin/bash
config=configs/2stage/2tower/crossmamba/normalkalman/mamba_swallow_i3d_secondstage_2tower_logitavgs_l3_ep30_acu4_loadheatmap_channelagg_normalkalman_vw0.7.yaml
