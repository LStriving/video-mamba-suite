...
for layer in ${layers[@]}; do
    config=configs/2stage/2tower/crossmamba/layers/mamba_swallow_i3d_secondstage_2tower_crossmamba_l3_ep30_acu4_loadheatmap_channelagg_layer${layer}.yaml
    ...
    config=configs/2stage/2tower/crossmamba/layers/mamba_swallow_i3d_secondstage_2tower_crossmamba_l3_ep30_acu4_loadheatmap_channelagg_layer${layer}_vw0.6.yaml
