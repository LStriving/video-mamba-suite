...
do
    ...
    do
        for epoch in "${epochs[@]}"
        do 
            echo "Redirecting output to outputs/${base_name}_single_actions/eval_${vw}_${action}_ep${epoch}.log"
            ...
            nohup python eval2tower.py \
                ...
                --tower_name CrossMambaEarlyFusion > outputs/${base_name}_single_actions/eval_${vw}_${action}_ep${epoch}.log
        done
    done
done
