#!/bin/bash
config=configs/2stage/2tower/crossmamba/ca/mamba_swallow_i3d_secondstage_2tower_crossmamba_l3_ep30_acu4_loadheatmap_channelagg_caadd.yaml
...
config=configs/2stage/2tower/crossmamba/ca/mamba_swallow_i3d_secondstage_2tower_crossmamba_l3_ep30_acu4_loadheatmap_channelagg_caadd_vw0.6.yaml
...
nohup python eval2tower.py \
    ...
    --image_size 128 \
    --calflops \
    --tower_name CrossMambaEarlyFusion > outputs/${base_name}/eval_${vw}_flops.log
