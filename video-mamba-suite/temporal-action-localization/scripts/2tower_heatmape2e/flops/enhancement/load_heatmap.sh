#!/bin/bash
config=configs/2stage/2tower/crossmamba/mamba_swallow_i3d_secondstage_2tower_crossmamba_l3_ep30_acu4_loadheatmap.yaml
...
cat outputs/${base_name}/eval_${vw}_flops.log
