...
config2=configs/2stage/heatmap/e2e/extract_model/heatmap_secondstage_videomamba_l3_avgtoken_ep45_sigma4_hid576_resnet.yaml
...
python train2tower.py \
    $config \
    $config2 \
    --backbone_2 ckpts/link2/e2e_heatmap_stage2_video_mamba_l3_ep45_sigma4_hid576_resnet \
    --output load_heatmap \
...
do
    ...
    nohup python eval2tower.py \
        ...
        --heatmap_dir tmp/raw_heatmap_sigma4_p0.23_resnet \
        --heatmap \
        --heatmap_sigma 4 \
        --heatmap_branch none \
        --heatmap_size 56 \
