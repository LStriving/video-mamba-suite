...
do
    ...
    --config2 configs/2stage/2tower/vw/mamba_swallow_i3d_secondstage_2tower_vw${vw}.yaml \
    --config3 configs/2stage/heatmap/e2e/heatmap_secondstage_mvit_mvit_p2l3_ep30_sigma4.yaml \
    --re-extract \
    --ckpt2 ckpts/link2/2tower \
    ...
    --heatmap_size 56 \
    --image_size 128 \
    --tower_nam LogitsAvg > outputs/2tower_heatmape2e/eval_${vw}.log
done