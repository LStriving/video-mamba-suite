...
# if [ ! -f outputs/$base_name/mamba_swallow_i3d_secondstage_lgte.log ]; then
    nohup python eval2stage.py --config2 $config2 --re-extract \
        ...
        --cache_dir tmp/threshold0.23 --image_size 128 --result_path outputs/$base_name > outputs/$base_name/mamba_swallow_i3d_secondstage_lgte.log
# fi
...
#         --image_size 128 > outputs/$base_name/$action_name.log
# done