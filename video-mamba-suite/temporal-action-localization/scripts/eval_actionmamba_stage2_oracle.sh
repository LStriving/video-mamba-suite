...
config2=configs/2stage/mamba_swallow_i3d_secondstage_multiclass_10ep.yaml
...
nohup python eval2stage.py --config $config --config2 $config2 --re-extract \
        --ckpt2 'ckpts/ckpt_swallow_stage2/mamba_swallow_i3d_secondstage_multiclass_swallow_stage2_multiclass_16_0.0001' \
        --only_perfect --train_set --infer_perfect_stage1 --perfect_stage1 ./tmp/swallow2_0427_i3d_rgb128_flow128_perfect/ \
        --seg_duration 5 \
        --cache_dir tmp/threshold0.23_swallow2 --image_size 128 > outputs/actionmamba_stage2_externaltest.log
echo outputs/actionmamba_stage2_externaltest.log
