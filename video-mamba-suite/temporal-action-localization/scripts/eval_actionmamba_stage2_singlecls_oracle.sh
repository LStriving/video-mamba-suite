...
echo outputs/actionmamba_stage2_singlecls_externaltest_10.log
nohup python eval2stage.py --config $config --config2 $config2 --re-extract \
        ...
        --seg_duration 5 \
        --cache_dir tmp/threshold0.23_swallow2 --image_size 128 > outputs/actionmamba_stage2_singlecls_externaltest_10.log
