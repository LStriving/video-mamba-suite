...
config2=configs/2stage/actionformer_swallow_i3d_secondstage_max192_25.yaml
...
echo outputs/actionformer_stage2_singlecls_externaltest.log
...
nohup python eval2stage.py --config $config --config2 $config2 --re-extract \
        ...
        --seg_duration 5 \
        --cache_dir tmp/threshold0.23_swallow2 --image_size 128 > outputs/actionformer_stage2_singlecls_externaltest.log
