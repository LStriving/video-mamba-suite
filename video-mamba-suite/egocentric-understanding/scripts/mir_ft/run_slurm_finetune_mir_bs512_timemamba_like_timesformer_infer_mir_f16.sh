...
OUTPUT_DIR="./work_dirs/finetune_mir_baseline_vitb_bs512_timemamba_like_timesformer"
...
srun -p ${PARTITION} \
    ...
    --resume /mnt/petrelfs/chenguo/workspace/video-mamba-suite-data/model_zoo/clip_timemamba_vanilla_base_bs512_f4_ft_ek100_mir_f16.pt \
    --evaluate
