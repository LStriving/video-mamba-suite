...
OUTPUT_DIR="./work_dirs/lavila_pretrain_baseline_deit_tiny_bs512_gpu8_f16"
...
srun -p ${PARTITION} \
    ...
    --fix-lr \
    --pretrain-zoo deit \
    --resume /mnt/petrelfs/chenguo/workspace/video-mamba-suite-data/model_zoo/deit_vit_tiny_bs512_f16.pt \
    --evaluate
