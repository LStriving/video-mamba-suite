...
OUTPUT_DIR="./work_dirs/lavila_pretrain_baseline_vivim_small_bs512_gpu8_f16"
...
srun -p ${PARTITION} \
    ...
    --fused-decode-crop \
    --fix-lr \
    --resume /mnt/petrelfs/chenguo/workspace/video-mamba-suite-data/model_zoo/deit_vivim_small_bs512_f16.pt \
    --evaluate
