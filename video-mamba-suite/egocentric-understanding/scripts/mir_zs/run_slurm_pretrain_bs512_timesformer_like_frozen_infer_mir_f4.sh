...
OUTPUT_DIR="./work_dirs/lavila_pretrain_baseline_vitb_bs512_timesformer_frozenintime"
...
srun -p ${PARTITION} \
    ...
    --fused-decode-crop \
    --fix-lr \
    --resume /mnt/petrelfs/chenguo/workspace/video-mamba-suite-data/model_zoo/clip_timesformer_frozen_base_bs512_f4.pt \
    --evaluate
