...
class Model(nn.Module):
    ...
    def __init__(self, transformer, position_embed, txt_position_embed, txt_dim, vid_dim,norm_epsilon=1e-5,ssm_cfg=None,
        ...
        if not use_mamba:
            ...
            dpr = [0.1 for x in torch.linspace(0, drop_path_rate, depth)]  # stochastic depth decay rule
    ...
    def forward(self, src_txt, src_txt_mask, src_vid, src_vid_mask, src_cls=None, src_cls_mask=None):
        ...
        #print(src_vid.shape,flush=True)
        ...
        hidden_states = self.transformer(src, ~mask, pos)
...
def build_model(args):
    ...
    model = Model(
        ...
        use_mamba=False, #only use transformer
        depth=args.depth,
        embed_dim=1024,
        drop_path=0.1,
        rms_norm=False,
